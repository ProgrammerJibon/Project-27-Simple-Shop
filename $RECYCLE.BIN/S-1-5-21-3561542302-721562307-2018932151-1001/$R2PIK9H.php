	...
	<form method="POST" class="card shadow p-3 mt-5 mb-5 bg-white rounded" style="max-width: 600px; margin: 0 auto;">
		...
		<div class="container">
			...
			<div class="form-row d-flex flex-wrap mb-2 mx-5 justify-content-between">
				...
				<div class="col-sm-8">
					<input required type="number" class="form-control form-control-sm" id="code" minlength="6" maxlength="7"  name="code">
				</div>
			</div>
			<div class="form-row d-flex flex-wrap mb-4 mt-3 mx-5 align-items-center justify-content-between">
				...
				<div class="col-sm-3">
					<button type="submit" name="submit_code" class="btn col-sm-12 btn-secondary"><?php echo t(22)[$l]; ?></button>
				</div>
				<div class="col-sm-4">
