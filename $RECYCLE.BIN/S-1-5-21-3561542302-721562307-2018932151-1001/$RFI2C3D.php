			...
			<div>
				<ul class="d-flex flex-wrap justify-content-between"><?php 
					foreach (explode("\n", $product_details['description']) as $details) {
						?> 
					<li class="col-sm-4"><?php $newDetails = explode(":", $details);
						if (isset($newDetails[1])) {
							echo "<span style=\"font-size: 13px; color: #f57224; font-weight: bold;\">".$newDetails[0].": </span><span style=\"font-size: 13px; color: #f57224;\">".$newDetails[1]."</span>";
						}else{
							echo "<span style=\"font-size: 13px; color: #f57224;\">".$details."</span>";
						}
					 ?></li>
					<?php
					}
