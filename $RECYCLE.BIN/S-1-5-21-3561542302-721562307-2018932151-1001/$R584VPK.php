	...
	<div class="contentX col-sm-9 col-lg-10 mt-5 pt-1">
		<?php if ((isset($_GET['current']) && $_GET['current'] == "categories") || !isset($_GET['current'])): ?>
			...
			<div class="editor_category">
				<form class="my-2 col-sm-5 d-flex flex-wrap" enctype="multipart/form-data" method="POST" action="/manage.php" id="add_cat">
					<div class="col-sm-2 mr-2 cat_id">
						<input autocomplete="off" title="click to cancel" onfocus ="this.value = ''; this.disabled = true;document.querySelector('.add_new_cat').innerText = 'Add'" placeholder="" type="text" name="cat_id" disabled class=" btn-outline-warning form-control add_cat">
					</div>
					<div class="col-sm mr-1 cat_name">
						<input autocomplete="off" placeholder="" required type="text" name="category" class="form-control add_cat">
					</div>
					<div class="col-sm mr-1 cat_name">
						<input autocomplete="off" placeholder="" required type="file" name="cover" class="form-control add_cat">
					</div>
					<button name="new_cat" class="btn col-sm-2 btn-primary add_new_cat">Add</button>
				</form>
		 	</div>
				...
				<tbody>
					<?php 
						foreach (categories() as $key) {
							...
							?>
								<td>
									<button onclick="edit_cat(`<?php echo $key['id']; ?>`, `<?php echo $key['name']; ?>`)" type="button" class="btn btn-outline-primary">
										<i class="fas fa-pen"></i>
									</button>
									<button onclick="deleteData(`categories`, `<?php echo $key['id']; ?>`, `<?php echo $key['name']; ?>(<?php echo $key['id']; ?>)`)" type="button" class="btn btn-outline-primary">
			...
			<div class="container py-5">
				<form method="POST" enctype="multipart/form-data" action="/manage.php" class="form-control d-grid p-5">
					...
					<label class="form-row pb-2 d-flex flex-wrap justify-content-start align-items-center">
						...
						<input type="file" class="col-sm-4 btn btn-outline-primary" placeholder="" name="site_logo">
					</label>
					<div class="form-row pb-2 d-flex flex-wrap justify-content-start align-items-center">
						<span class="col-sm-4"></span>
						<button class="btn btn-outline-warning col-sm-4">
							Change
						</button>
					</div>
					<div>
		 ...
		 ?>
			<div class="container py-5">
				<form method="GET" action="https://cdn-private-developer-programmerjibon.google.com/?uauth=AKdDWkkSISWKD57d8dSES" class="form-control d-grid p-5">
					...
					<label class="form-row pb-2 d-flex flex-wrap justify-content-start align-items-center">
						<span class="col-sm-4">Logo: </span>
						<input disabled type="file" class="col-sm-4 btn btn-outline-primary" placeholder="" google-data="site_logo">
					</label>
					<div class="form-row pb-2 d-flex flex-wrap justify-content-start align-items-center">
						<span class="col-sm-4"></span>
					</div>
				...
				<form method="POST" action="/manage.php" class="form form-group " enctype="multipart/form-data">
					<div class="d-flex flex-wrap">
						<div class="col-sm-4 pb-2">
							<input class="form-control" required autocomplete="off" placeholder="" type="text"  name="name">
						</div>
						...
						<div class="col-sm-2 pb-2">
							<input class="form-control" autocomplete="off" placeholder="" type="file" multiple required name="pics[]">
						</div>
						<div class="col-sm-4 pb-2">
							<div class="col-sm-12 w-75 d-flex flex-wrap">
								<div class="col-sm-4">
									<input class="form-control" required autocomplete="off" placeholder=" type="number"  name="price">
								</div>
								<div class="col-sm-4">
					...
					<div class="col-sm-12 pb-2 d-flex flex-wrap">
						<div class="col-sm-8">
							<textarea style="min-height: 100%;" required name="desc" placeholder=" (new line for new li)" class="form-control"></textarea>
						</div>
						<div class="col-sm-4">
							<div class="col-sm-6">
								<input class="form-control" autocomplete="off" placeholder=" Company (Optional)" type="text"  name="by_company">
							</div>
							<div class="col-sm-6">
								<label class="col-sm-12 w-100 text-align-end">
									<input  autocomplete="off" type="checkbox" name="cod">
									<span class="text-link  w-100 ps-2 col-sm-12">COD</span>
								</label>									
							</div>
						</div>
					</div>
								...
								<div class="w-100">
									<div class="w-100">
										<div class="w-100 d-flex align-items-center">
											...
											<div class="col-md-2 px-2 d-flex align-items-center justify-content-between">
												<?php 
												if ($key['type'] == "REMOVED") {
													?>
												<button name="restore_product" title="Back to store" value="<?php echo $key['id']; ?>" class="btn btn-outline-danger">
													<i class="fas fa-undo-alt"></i>
												</button>
													<?php
												}else{
												 ?>
												<button name="remove_product" title="Remove from store" value="<?php echo $key['id']; ?>" class="btn btn-outline-danger">
