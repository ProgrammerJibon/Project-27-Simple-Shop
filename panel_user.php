			...
			<div class="container my-2" style="user-select: text;">
				...
				<table class="table  table-striped">
					<tbody>
						...
						$sql_coupons = "SELECT * FROM `vouchers` WHERE `user` = '$user_data[id]' AND `validity` BETWEEN '$time' AND '$exarm_time' ORDER BY `vouchers`.`id` DESC";
						...
						if (mysqli_num_rows($sql_coupons) > 0) {
							...
							<tr>
								<td>
									<div class="p-3">
										<h6 style="color: #950318;"><?php echo ucwords($key['name']); ?></h6>
										<h6 style="color: orange;">Value: <?php echo $site_currency_icon.($key['value']); ?></h6>
							...
							echo "No coupons available. You can get coupons after buying product or any referrer or even from the shop.";
						}
						 ?>
					</tbody>
				</table>
									...
									<div class="d-flex flex-wrap justify-content-between align-items-center">
										<div class="d-flex flex-wrap align-items-center">
											...
											<div class="px-3">
												...
												<div>
													<div>Price: <b><?php echo $site_currency_icon.($key['product_price'] - $key['voucher_value']); ?></b></div>
													...
													<div><?php 
														if ($key['voucher_data'] !== "") {
															...
															Voucher Desc: <b><?php echo $key['voucher_data']; ?></b>
															<br>
															Voucher value: <b><?php echo $site_currency_icon.$key['voucher_value']; ?></b>
															<?php
														}
														 ?>
													</div>
